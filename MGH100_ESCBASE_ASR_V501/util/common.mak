...
BUILDPACKAGE_NAME  ?= $(notdir $(subst /util,,$(CURDIR)))
...
#
GEN_OUTPUT_PATH ?= $(TRESOS_BASE)\generated
...
#################################################################
# GEN_OUTPUT_PATH modification prevention
GEN_OUTPUT_PATH := $(TRESOS_BASE)\generated
...
#
CC_FILES_TO_BUILD += $(wildcard $(TRESOS_BASE)/source/application/*.c) \
                     $(wildcard $(TRESOS_BASE)/source/application/$(TARGET)/*.c) \
                     $(wildcard $(TRESOS_BASE)/source/application/$(TARGET)/$(DERIVATE)/*.c) 
                     $(wildcard $(TRESOS_BASE)/source/stubs/*.c) \
                     $(wildcard $(TRESOS_BASE)/source/stubs/$(TARGET)/*.c) \
                     $(wildcard $(TRESOS_BASE)/source/stubs/$(TARGET)/$(DERIVATE)/*.c)
...
#                    c:\more_includes
#
CC_INCLUDE_PATH  += $(TRESOS_BASE)\source\stubs
CC_INCLUDE_PATH  += $(TRESOS_BASE)\source\stubs\$(TARGET)
CC_INCLUDE_PATH  += $(TRESOS_BASE)\source\stubs\$(TARGET)\$(DERIVATE)
CC_INCLUDE_PATH  += $(TRESOS_BASE)\source\application
CC_INCLUDE_PATH  += $(TRESOS_BASE)\source\application\$(TARGET)
CC_INCLUDE_PATH  += $(TRESOS_BASE)\source\application\$(TARGET)\$(DERIVATE)
CC_INCLUDE_PATH  += $(TRESOS_BASE)\source\boards\$(BOARD)
CC_INCLUDE_PATH  += $(TRESOS_BASE)\source\config
CC_INCLUDE_PATH  += $(TRESOS_BASE)\source\config\$(TOOLCHAIN)
CPP_INCLUDE_PATH +=
ASM_INCLUDE_PATH += $(TRESOS_BASE)\source\boards\$(BOARD)
...
MANDO_DIR    := $(UTIL_DIR)\mando
include $(MANDO_DIR)\mando.mak
