...
::
:: TOOLCHAIN: GNU Make 4.0
::
:: Copyright (c) 2005 - 2017 Elektrobit Automotive GmbH
::  - all rights reserved -
::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
@ECHO OFF
...
:: gliwa perlscript
:gliwa
ECHO Call perl script for T1
cmd /c ".\..\..\..\SourceCode\BSW\Gliwa\Gliwa_Autosar\T1\make\T1_Tresos\T1_projGen.bat"
GOTO :eof

:call_make
CALL del make.log
%MAKE_EXE% %MAKE_OPTIONS% %* 2>&1 | wtee make.log
